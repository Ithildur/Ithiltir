...
ALTER TABLE server_metrics
    ADD COLUMN IF NOT EXISTS psi_cpu_some_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_some_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_some_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_some_total BIGINT,
    ADD COLUMN IF NOT EXISTS psi_cpu_full_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_full_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_full_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_cpu_full_total BIGINT,
    ADD COLUMN IF NOT EXISTS psi_memory_some_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_some_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_some_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_some_total BIGINT,
    ADD COLUMN IF NOT EXISTS psi_memory_full_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_full_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_full_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_memory_full_total BIGINT,
    ADD COLUMN IF NOT EXISTS psi_io_some_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_some_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_some_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_some_total BIGINT,
    ADD COLUMN IF NOT EXISTS psi_io_full_avg10 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_full_avg60 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_full_avg300 DOUBLE PRECISION,
    ADD COLUMN IF NOT EXISTS psi_io_full_total BIGINT;
